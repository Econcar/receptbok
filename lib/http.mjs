// HTTP-hjälpare. Används av receptimporten, som hämtar en sida i taget när
// användaren klistrar in en länk – inte som en crawler. Ändå gäller samma
// hyfs: identifiera oss ärligt, backa av vid 429, ge upp i tid.
//
...
const USER_AGENT =
  'receptbok/0.1 (+https://github.com/Econcar/receptbok; personlig receptsamling)';
